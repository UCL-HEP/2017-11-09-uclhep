...
of packages, you can list them on the command line.  For example:
  ...
  python swc-installation-hep.py git virtual-editor
...
class ROOTPythonPackage (PythonPackageDependency):
    def _get_version_from_package(self, package):
        return package.gROOT.GetVersion()
...
CHECKER['ROOT'] = ROOTPythonPackage(
    package='ROOT', name='PyROOT')
